  ...
  return (
    <>
      <div className="container mx-auto px-6">
        <div className="flex flex-col lg:flex-row items-center sm:justify-center gap-10 sm:gap-20 my-10 sm:my-20">
          <div>
            <Image
          ...
          <div className="space-y-2 sm:space-y-6  text-center lg:text-left">
            ...
            />
            <p className="mx-auto text-base text-balance md:text-xl lg:text-2xl lg:w-[690] ">
